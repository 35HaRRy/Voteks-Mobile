...
public class Constants {
    public static final String ACTION_SEARCH = "com.hayrihabip.voteks.action.SEARCH";
    public static final String ACTION_DOWNLOAD = "com.hayrihabip.voteks.action.DOWNLOAD";
